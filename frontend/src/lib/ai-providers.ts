...
export const CAPABILITIES: CapabilityDef[] = [
    ...
    { id: 'chat_subagent', label: 'Chat Subagent', description: 'Specialist subagents for research, protocol building, and run planning' },
    { id: 'chat_summary', label: 'Chat Summary', description: 'Condenses long chat histories when context limits are reached' },
