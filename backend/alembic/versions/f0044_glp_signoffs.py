...
down_revision: Union[str, Sequence[str], None] = "f0043"
...
def upgrade() -> None:
    ...
    # ------------------------------------------------------------------
    # 9. Add equipment calibration columns (Date, not DateTime — decision #17)
    # ------------------------------------------------------------------
    op.add_column(
        "equipment",
...
def downgrade() -> None:
    ...
    op.drop_column("equipment", "next_calibration_date")
